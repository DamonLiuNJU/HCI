...
public interface StudentDataService extends DataService{
	public ArrayList<String> getCourseList(StudentPO studentnumber) throws RemoteException;
	...
	public boolean addCourseNo(StudentPO coursenumber$studentnumber) throws RemoteException;
