...
public interface TempSelectionDataService extends DataService{
	...
	public void delete(String student_id,String course_id)throws RemoteException;
	...
	public TempSelectionPO findOne(String student_id,String course_id)throws RemoteException;
