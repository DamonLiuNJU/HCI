...
public class CoursePO implements Serializable {
	...
	public CoursePO(String id, String name, String teacherID, String campus,
			String grade, String place, String time, String period,
			String require, String facultyID, String credit, String module,
	...
	public String getValues() {
		...
		sb.append("(");
		sb.append(s(id) + "," + s(name) + "," + s(teacherID) + "," + s(campus)
				+ "," + s(grade) + "," + s(place) + "," + s(time) + ","
				+ s(period) + "," + s(require) + "," + s(facultyID) + ","
				+ s(credit) + "," + s(module) + "," + s(limit) + ","
				+ s(specificInfo));
		sb.append(")");
		return sb.toString();
	}
