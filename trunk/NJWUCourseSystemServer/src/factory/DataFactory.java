...
import data.datafactoryimpl.DataFactorySqlImpl;
import data.datafactoryimpl.DataFactoryTxtImpl;
...
public class DataFactory implements ServerReplyMessage{
	...
	public DataService createData(String type) {
		try{
			...
			}else if(type.equals("TxtDataFactory")){
				return new DataFactoryTxtImpl();
			}
			else{
