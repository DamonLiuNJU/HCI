...
//					mod.addRow(line);
//				
//				DefaultTableModel newdtm = (DefaultTableModel)table.getModel();
//				int dtmsize = dtm.getRowCount();
//				for( int i = 0 ;i < dtmsize ; i++){
//					dtm.removeRow(0);
//				}
//				int newdtmsize = newdtm.getRowCount();
//				int columnsize = newdtm.getColumnCount();
//				for (int  i = 0 ; i < newdtmsize ; i++){
//					Vector<String> line = new Vector<String>();
//					for( int j = 0 ; j < columnsize ;j++){
//						String content = (String) newdtm.getValueAt(i, j);
//						line.add(content);
//					}
//					dtm.addRow(line);
//					 
