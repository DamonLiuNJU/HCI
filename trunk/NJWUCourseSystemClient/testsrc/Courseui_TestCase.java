...
import presentation.courseui.CourseInfoFrame;
import presentation.courseui.CourseInfoTextArea;
...
public class Courseui_TestCase {
	...
	public static void main(String arg[]){
		...
		//测试CourseInfoFrame.CourseInfoFrame:得到包含查询的课程号详细信息的窗口
						//课程号存在【success
		//					test_getCourseInfoFrame("c000101");	
		...
		//测试CourseInfoTextArea.getCourseInfo:得到包含传入课程号的详细信息的JTextArea
						//课程号存在【success
		//					test_getCourseInfoTextArea("c000101");	
						//课程号不存在【success
